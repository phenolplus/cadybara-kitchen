...
The shared harness lives in `projects/local-training/`. This folder owns the
actual study setup: prompt ladder, model-family sweep config, review protocol,
and worker instructions for running the study on another computer.
...
For a longer paper-scale run, use
`projects/wall-planter-cad-study/configs/family_sweep.yaml`, which keeps the
...
```text
projects/wall-planter-cad-study/workspace/runs/wall_planter_morning_sweep_001/
projects/wall-planter-cad-study/workspace/runs/wall_planter_morning_sweep_002/
projects/wall-planter-cad-study/workspace/runs/wall_planter_morning_sweep_003/
```
...
```text
projects/wall-planter-cad-study/workspace/reviews/<experiment_id>_reviews.jsonl
```

Export the large attempt table to CSV:

```powershell
cadybara export-csv projects/wall-planter-cad-study/workspace/runs/wall_planter_morning_sweep_001/results.jsonl projects/wall-planter-cad-study/workspace/legacy/wall_planter_attempts.csv
```
