param(
    [string]$ConfigPath = "projects/cadybara-online-testing/configs/online_smoke.yaml",
...
Write-Host ""
Write-Host "Next: powershell -ExecutionPolicy Bypass -File projects/local-running/scripts/worker_start_lab.ps1" -ForegroundColor Cyan
